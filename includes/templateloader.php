...
class TemplateLoader
{
	...
	public function locate_template( $template_name, $template_path = '', $default_path = '' ) {
		...
		if ( ! $template_path ) {
			$template_path = trailingslashit( MD_TEMPLATE_PATH );
		}

		// Set default plugin templates path.
		if ( ! $default_path ) {
			$default_path = MD_ABSPATH . 'templates/'; // Path to the template folder
		}
		...
		return apply_filters( MD_PLUGIN_SHORTNAME . '_locate_template', $template, $template_name, $template_path, $default_path );
	}
